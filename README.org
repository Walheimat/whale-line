...
The easiest way here is using advice in combination with a stateful
segment or a stateless getter-based segment.
...
(whale-line-create-augment my-augment
  ...
  :advice (:after-while . (whale-line-stateful--get-segment)))
#+end_src
...
*** Shared properties of all types
